...
async function sendOtpEmail(toEmail, otp) {
  await transporter.sendMail({
    from: `"AI for 6G Security Workshop" <${process.env.GMAIL_USER}>`,
    to: toEmail,
    subject: 'Your verification code — AI for 6G Security Workshop',
    text:
      `Your verification code is: ${otp}\n\n` +
      `This code expires in 10 minutes. If you didn't request this, you can safely ignore this email.`,
    html:
      `<div style="font-family: Arial, sans-serif; font-size: 15px; color: #1a1a1a;">` +
      `<p>Your verification code for the <strong>AI for 6G Security</strong> workshop registration is:</p>` +
...
async function sendConfirmationEmail(toEmail, details) {
  ...
  await transporter.sendMail({
    from: `"AI for 6G Security Workshop" <${process.env.GMAIL_USER}>`,
    to: toEmail,
    subject: 'Registration Confirmed — AI for 6G Security Workshop',
    text:
      `Hi ${fullName || 'there'},\n\n` +
      `Your registration for the AI for 6G Security Workshop is confirmed.\n\n` +
    ...
    html:
      ...
      `<p>Your registration for the <strong>AI for 6G Security Workshop</strong> is confirmed.</p>` +
